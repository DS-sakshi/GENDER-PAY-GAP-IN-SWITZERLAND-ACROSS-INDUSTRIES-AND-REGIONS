...
\bibitem{GrossPay} Bundesamt für Statistik (BFS). (2023). Employed persons according to economic activity status, brackets of gross income from employment, work-time percentage and gender \\
